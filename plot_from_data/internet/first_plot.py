...
file_inf = "256nodes_diameter6_cutoff5.0-repetitions50-overlap100.xlsx"
# file_2_0 = "512nodes_diameter4_cutoff2.0-repetitions50-overlap100.xlsx"

# Load the datasets
df_inf = pd.read_excel(f"./../results/internet_graphs2/d=dby2-error=0.2-opr=all-n=256-good1/{file_inf}")
